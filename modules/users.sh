...
while true; do
    ...
    echo -e "${CYAN}╠════════════════════════════════════╦═════════════════════════╣${NC}"
    echo -e "${CYAN}║${NC} SSH MANAGER                        ${CYAN}║${NC} V2RAY MANAGER                     ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [01] Crear Usuario SSH             ${CYAN}║${NC} [09] Crear VLESS TCP                ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [02] Eliminar Usuario SSH          ${CYAN}║${NC} [10] Crear VLESS WS                 ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [03] Renovar Usuario SSH           ${CYAN}║${NC} [11] Crear VMESS WS                 ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [04] Cambiar Contraseña SSH        ${CYAN}║${NC} [12] Crear TROJAN WS                ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [05] Lista de Usuarios SSH         ${CYAN}║${NC} [13] Renovar Usuario V2Ray          ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [06] Usuarios Online SSH           ${CYAN}║${NC} [14] Eliminar Usuario V2Ray         ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} [07] Eliminar Expirados            ${CYAN}║${NC} [15] Lista de Usuarios V2Ray        ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC}                                    ${CYAN}║${NC} [16] Usuarios Online V2Ray          ${CYAN}║${NC}"
    echo -e "${CYAN}╠════════════════════════════════════════╩═════════════════════════╣${NC}"
    ...
    case $opt in
        ...
        9) crear_usuario_v2ray "VLESS TCP" ;;
        10) crear_usuario_v2ray "VLESS WS" ;;
        11) crear_usuario_v2ray "VMESS WS" ;;
        12) crear_usuario_v2ray "TROJAN WS" ;;
